    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.colors.store")); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('color') ? 'is-invalid' : ''); ?>" type="text" name='color_name' id="color" value="<?php echo e(old('color', '')); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\car\resources\views/admin/colors/create.blade.php ENDPATH**/ ?>