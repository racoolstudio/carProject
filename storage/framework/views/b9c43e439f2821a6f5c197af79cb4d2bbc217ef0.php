                ...
                <tbody>
                    <?php $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($car->id); ?>">
                            ...
                            <td>
                                <?php echo e($car->manufacturer->manufacturer_name
                                 ?? ''); ?>

                            </td>
                            <td>
                                <?php echo e($car->year->year_name ?? ''); ?>

                            </td>
                            <td>
                                <?php echo e($car->model->model_name ?? ''); ?>

</td>
<td>
                                <?php echo e($car->color->color_name ?? ''); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\car\resources\views/admin/cars/index.blade.php ENDPATH**/ ?>