    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.customers.store")); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('other_name') ? 'is-invalid' : ''); ?>" type="text" name="other_name" id="other_name" value="<?php echo e(old('other_name', '')); ?>" >
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\car\resources\views/admin/customers/create.blade.php ENDPATH**/ ?>