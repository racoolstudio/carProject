    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.years.store")); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('year') ? 'is-invalid' : ''); ?>" type="text" name='year_name' id="year" value="<?php echo e(old('year', '')); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\car\resources\views/admin/years/create.blade.php ENDPATH**/ ?>